...
public class NavigationManager {
    ...
    private Stack<Task_5.T1.Menu> menuStack;
    ...
    public void pushMenu(Task_5.T1.Menu menu) {
        menuStack.push(menu);
    }
    ...
    public Task_5.T1.Menu getCurrentMenu() {
        return menuStack.isEmpty() ? null : menuStack.peek();
    }

    public void printCurrentMenu() {
        Task_5.T1.Menu currentMenu = getCurrentMenu();
        if (currentMenu != null) {
            currentMenu.printMenu();
        }
    }

    public void navigateTo(Task_5.T1.Menu menu, boolean showMenu) {
        pushMenu(menu);
        if (showMenu) {
            printCurrentMenu();
        }
